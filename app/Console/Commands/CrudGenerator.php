...
class CrudGenerator extends Command
{
    ...
    public function handle()
    {
        ...
        \File::append(base_path('routes/api.php'), "use App\Http\Controllers\\{$name}Controller;".PHP_EOL);
        \File::append(base_path('routes/api.php'), 'Route::resource(\'' . Str::plural(strtolower($name)) . "', {$name}Controller::class);".PHP_EOL);
